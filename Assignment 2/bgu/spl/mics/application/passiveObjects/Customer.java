...
public class Customer implements Serializable{
	...
	public String toString(){
		return name+" id is"+ Id+" distance is"+distance +" "+address+" ,credit amount "+creditAmount+" ,credit number is "+creditNumber+orderReceipts.get(0).getBookTitle();
	}
	...
	public  void addReceipts(List<OrderReceipt> O){

	for(int i=0;i<O.size();i++){
		orderReceipts.add(O.get(i));
	}
	}
}

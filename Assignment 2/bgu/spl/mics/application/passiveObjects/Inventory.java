...
/* this function is unsynchronized!
	...
	public void printInventoryToFile(String filename){
		...
		HashMap<String, Integer> clonedInventory = cloneInventory();
	...
	private synchronized HashMap<String, Integer> cloneInventory() {
		HashMap<String, Integer> clonedInventory = new HashMap<>();
